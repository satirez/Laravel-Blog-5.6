				...
				<div class="card">
					<div class="card-header">
					    <nav class="navbar navbar-light bg-light">
						  ...
						  <a href="{{route('tags.create')}}" class="btn btn-sm btn btn-primary pull-right">		
							Crear
						</a>
						</nav>			
					  </div>
						...
						<div class="card-body">
							<table class="table table-bordered">
								...
								<tbody>
									 ...
									 @foreach($tags as $tag)
									<tr>
										<td class="table-success" >{{ $tag->id }}</td>
		                                <td>{{ $tag->name }}</td>
		                                <td width="10px">
		                                   <a href="{{ route('tags.show', $tag->id) }}" class="btn btn-sm btn btn-info">

		                                   <i class="fa fa-eye"></i> Ver</a>
		                                </td>
		                                <td width="10px">
		                                    <a href="{{ route('tags.edit', $tag->id) }}" class="btn btn-sm btn btn-warning"> <i class="fa fa-edit"></i> Editar</a>
		                                </td>
